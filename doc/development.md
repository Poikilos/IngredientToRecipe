# Development
This document is only for developers. It will not help you use the guide itself. See [../readme.md](../readme.md) if you just want to use the guide.

You need to download that file from GameFAQs because AIex says not to use it without permission. I removed the file for that reason. However, I also made fixes to it. Therefore, for non-developers I recommend you use the html file I produced using the exe. The URL is at the release page.

## Compiling
These instructions explain how to compile the guide from multiple sources (See [../readme.md](../readme.md) if you just want to use the guide).
